"""Otsu thresholding filter - custom implementation using NumPy primitives."""
...
def apply_otsu(image: np.ndarray) -> np.ndarray:
    ...
    logger.info(f"Otsu - Optimal threshold: {optimal_threshold}, "
    ...
    logger.info(f"Otsu thresholding - Output shape: {result.shape}, "
